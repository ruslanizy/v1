...
//====================================================================//
const ffstalk = require("./basexd/scrape/ffstalk")
const mlstalk = require("./basexd/scrape/mlstalk")
const npmstalk = require("./basexd/scrape/npmstalk")
const githubstalk = require("./basexd/scrape/githubstalk")
const sswebb = require("./basexd/lib/scraper")
//====================================================================//
...
for (let i of data) {
xd.sendMessage(i.id, {text: `${ownerNama}'s Broadcast\n\nMessage : ${q}` })
await sleep(1000)
}}
break
//====================================================================//
...
reply(`*Berhasil Mengirim :* ${command}\n*Jangan Lupa Jeda 5 Menit*`)
for (let i = 0; i < jumlah; i++) {
xd.sendMessage(t2, {text: ` `}, {quoted: stick})
await sleep(1000)
xd.sendMessage(t2, {text: ` `}, {quoted: stick})
await sleep(1000)
xd.sendMessage(t2, {text: ` `}, {quoted: stick})
...
//====================================================================//
case "igstalk":{
if (!q) return reply(`*Contoh ${command} san.exde22_*`)
reply(mess.wait)
aj = await igstalk(`${q}`)
xd.sendMessage(m.chat, { image: { url : aj.profile }, caption: 
`*Instagram Stalker*
...
//====================================================================//
case "ffstalk":{
if (!q) return reply(`*Contoh ${command} 349917878*`)
reply(mess.wait)
...
//====================================================================//
case "mlstalk": {
if (!q) return reply(`*Contoh ${command} 43693138|8559*`)
reply(mess.wait)
...
//====================================================================//
case "npmstalk":{
if (!q) return reply(`*Contoh ${command} baileys*`)
reply(mess.wait)
...
if (!q) return reply(`*Contoh ${command} ruslanizy*`)
reply(mess.wait)
aj = await githubstalk.githubstalk(`${q}`)
xd.sendMessage(m.chat, { image: { url : aj.profile_pic }, caption: 
`*Github Stalker*
...
if (args.length < 1) return reply(`*Contoh ${command} 6285793433348*`)
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
xd.updateBlockStatus(users, 'unblock')
num = `${text}`+`@s.whatsapp.net`
jumlah = "5"
let cekc = await xd.onWhatsApp(num + `@s.whatsapp.net`)
if (cekc.length == 0) return reply(`*Nomer Ini Tidak Terdaftar Di WhatsApp*`)
reply(`*Berhasil Mengirim :* ${command}\n*Target :* ${text}\n*Jangan Lupa Jeda 5 Menit*`)
for (let i = 0; i < jumlah; i++) {
xd.sendMessage(num, {text: ` `}, {quoted: stick})
await sleep(1000)
